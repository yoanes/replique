...
function of_recognized_background_repeat() {
	...
	$default = array(
		'no-repeat' => __( 'No Repeat', 'nature-one' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'nature-one' ),
		'repeat-y'  => __( 'Repeat Vertically', 'nature-one' ),
		'repeat'    => __( 'Repeat All', 'nature-one' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'nature-one' ),
		'top center'    => __( 'Top Center', 'nature-one' ),
		'top right'     => __( 'Top Right', 'nature-one' ),
		'center left'   => __( 'Middle Left', 'nature-one' ),
		'center center' => __( 'Middle Center', 'nature-one' ),
		'center right'  => __( 'Middle Right', 'nature-one' ),
		'bottom left'   => __( 'Bottom Left', 'nature-one' ),
		'bottom center' => __( 'Bottom Center', 'nature-one' ),
		'bottom right'  => __( 'Bottom Right', 'nature-one')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'nature-one' ),
		'fixed'  => __( 'Fixed in Place', 'nature-one')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'nature-one' ),
		'italic'      => __( 'Italic', 'nature-one' ),
		'bold'        => __( 'Bold', 'nature-one' ),
		'bold italic' => __( 'Bold Italic', 'nature-one' )
		);
